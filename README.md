...
</br><img src="source/yahoo分词top30统计图.png" width = 70% height = 15% />    

</br>（2）csdn口令集中，top30常用英文分词如下：
</br><img src="source/csdn_word_top_30.PNG" width = 15% height = 15% />  
</br><img src="source/CSDN分词top30统计图.png" width = 70% height = 15% />    
...
* Markov    
  ...
  一阶马尔科夫用到的历史信息较少，所以精确度较低，但是高阶马尔科夫模型会由于数据稀疏容易导致过拟合现象，所以下一步考虑使用变阶马尔科夫模型生成口令集。
